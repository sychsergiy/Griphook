...
class TestProjectCreateSettingsAPI:
    def test_create_project(self, client, db_session):
        ...
        resp = client.post(url_for('settings_project.project-create'), data=json.dumps(test_data))
...
class TestProjectUpdateTitleSettingsAPI:
    def test_update_project(self, client, db_session, create_project_settings_test_data):
        ...
        resp = client.put(url_for('settings_project.project-update-title'), data=json.dumps(test_data))
        assert resp.status_code == 200
...
class TestProjectDeleteSettingsAPI:
    def test_delete_project(self, client, create_project_settings_test_data):
        test_data = {'id': 1}
        resp = client.delete(url_for('settings_project.project-delete'), data=json.dumps(test_data))
        assert resp.status_code == 200
        assert resp.json == {'success': True}
...
class TestProjectAttachToServicesGroupSettingsAPI:
    def test_attach_project(self, client, create_project_settings_test_data, create_services_group_test_data):
        ...
        resp = client.put(url_for('settings_project.project-attach'), data=json.dumps(test_data))
        assert resp.status_code == 200
        assert resp.json == {'success': True}
...
class TestProjectDetachFromServicesGroupSettingsAPI:
    def test_detach_project(self, client, create_project_services_group_test_data):
        ...
        resp = client.put(url_for('settings_project.project-detach'), data=json.dumps(test_data))
        assert resp.status_code == 200
        assert resp.json == {'success': True}
