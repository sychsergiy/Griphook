...
from griphook.server.models import Server, Service, MetricBilling, BatchStoryBilling, Cluster
...
class ClusterServersStrategy(ChildrenStrategyAbstract):
    ...
    def convert_data_to_useful_form(self, query_result):
        ...
        :return:
        """
        chart_data = [(f'{cluster}:{server}', value)
                      for (cluster, server, value) in query_result]
