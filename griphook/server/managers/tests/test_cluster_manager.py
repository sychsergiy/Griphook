...
class TestSetCPUPrice:
    def test_set_cpu_price(self, db_session, create_server_cluster_test_data):
        ...
        ClusterManager(db_session).set_cpu_price(
            cluster_id=test_cluster_id, new_cpu_price=test_new_cpu_price
        )
        cluster_cpu_price = (
            db_session.query(Cluster.cpu_price)
    ...
    def test_set_cpu_price_when_price_was_set(
        self, db_session, create_server_cluster_test_data
    ):
        test_cluster_id = 1
