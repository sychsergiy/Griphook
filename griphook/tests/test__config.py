# griphook/server/tests/test_config.py
...
class TestDevelopmentConfig(TestCase):
    def create_app(self):
        app.config.from_object("griphook.server.config.DevelopmentConfig")
        return app
...
class TestProductionConfig(TestCase):
    def create_app(self):
        app.config.from_object("griphook.server.config.ProductionConfig")
        return app
